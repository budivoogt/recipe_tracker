...
<div class="m-6 flex flex-col mx-auto">
	...
	<form
		...
		use:enhance
		class="flex flex-col gap-4 w-64 mx-auto"
	...
	>
		...
		<button
			...
			disabled={!passwordsMatch}>Change password</button
		>
	</form>
	{#if form?.success}
		<span> Your password has been changed successfully. Log in with your new password. </span>
	{:else if form?.error}
