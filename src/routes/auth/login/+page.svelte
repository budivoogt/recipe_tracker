...
<div class="m-6 flex flex-col mx-auto">
    ...
    <p class="my-4 text-center">You are not logged in. Login below or create an account.</p>
    <form method="POST" action="/auth?/login" use:enhance class="flex flex-col gap-4 w-64 mx-auto">
        ...
        <a href="/auth/register" class="flex flex-col grow">
            <button class="shadow text-white p-1 rounded-lg bg-orange-400 border-none hover:bg-orange-500">Register</button>
        </a>
    </form>
    {/if}
